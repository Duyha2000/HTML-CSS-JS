// Object đại diện cho 1 đối tượng nào đấy (1 người, 1 cái xe, 1 cái nhà)
// 1 người tên Đức:
// Thuộc tính CMND, Tên, tuổi, nghề nghiệp (thuộc tính - key khác nhau)
// CMND: 029201019201 (giá trị)
// Tên: Đức
...
// Giả sử muốn lấy tên Đức
// Cú pháp truy cập 1 thuộc tính trong object
...
//   },
// ];
// console.log(studentList[1].age); // 25
...
let id = student2.id;
let name2 = student2.name2;
let age = student2.age;
*/

const { id, name2, age } = student2;
// Copy 1 object
// const {...copyStudent2} = student2
console.log(id, name2, age);

// Destructuring array
const arr = ["sony", "apple", "samsung"];
/*
const sony = arr[0]
const apple = arr[1];
const samsung = arr[2];
*/
let [sony, apple, samsung] = arr;
/*
Copy array
let [...arr2] = arr;
console.log(sony); // sony
console.log(arr2); // ["sony", "apple", "samsung"]
*/

// Các kiểu dữ liệu trong JS
// Kiểu dữ liệu nguyên thủy: string - number - boolean (true/false) - null - undefined
...
// Optional chaining (lựa chọn xâu chuỗi)
...
//     male: true,
//     info: {
//       phoneNumber1: +84123456789,
//       phoneNumber2: +84123456789,
//     },
//   },
...
// console.log(students[1]?.info?.phoneNumber2); //error

// console.log(5);
// Array Map - khi nào
// Duyệt qua một mảng và muốn được trả về 1 mảng mới
// forEach: duyệt mảng và thay đổi trực tiếp mảng
// 1 cuốn sách
// Map
const students = [
  {
  ...
  { name: "Tran", age: null, male: false, phoneNumber: +84123456789 },
  { name: "Duc", age: 23, male: false, phoneNumber: +84123456789 },
];

// const studentData =
//   students.map(({ name, age }) => {
//     return `<p> Name: ${name} - ${age ?? "N/A"} </p>`;
//   }) ?? [];
    ...
    products: [
      {
        ...
        updatedAt: "2023-12-21T03:25:38.997Z",
      },
      {
        ...
        updatedAt: "2023-12-21T02:51:54.524Z",
      },
      {
        ...
        updatedAt: "2023-12-20T13:24:33.732Z",
      },
      {
        ...
        updatedAt: "2023-12-20T13:29:04.704Z",
      },
      {
        ...
        updatedAt: "2023-12-21T02:50:14.360Z",
      },
      {
        ...
        updatedAt: "2023-12-20T12:26:55.590Z",
      },
      {
        ...
        updatedAt: "2023-12-21T03:26:18.867Z",
      },
      {
        ...
        updatedAt: "2023-12-20T07:42:00.340Z",
      },
      {
        ...
        updatedAt: "2023-12-20T07:34:01.907Z",
      },
      {
        ...
        updatedAt: "2023-12-20T12:26:50.623Z",
      },
      {
        ...
        updatedAt: "2023-12-20T07:42:04.273Z",
      },
      {
        ...
        updatedAt: "2023-12-19T10:38:53.094Z",
      },
      {
        ...
        updatedAt: "2023-12-20T13:25:26.511Z",
      },
      {
        ...
        updatedAt: "2023-12-18T13:58:20.876Z",
      },
      {
        ...
        updatedAt: "2023-12-18T15:12:30.382Z",
      },
      {
        ...
        updatedAt: "2023-12-20T13:25:51.659Z",
      },
      {
        ...
        updatedAt: "2023-12-18T15:46:01.080Z",
      },
      {
        ...
        updatedAt: "2023-12-20T07:42:18.172Z",
      },
      {
        ...
        updatedAt: "2023-12-20T07:42:20.548Z",
      },
      {
        ...
        updatedAt: "2023-12-19T16:19:48.506Z",
      },
      {
        ...
        updatedAt: "2023-12-15T15:09:56.220Z",
      },
      {
      ...
      },
      {
        ...
        updatedAt: "2023-12-14T06:21:03.948Z",
      },
      {
        ...
        updatedAt: "2023-12-15T17:10:37.736Z",
      },
      {
        ...
        updatedAt: "2023-12-18T13:58:16.106Z",
      },
      {
        ...
        updatedAt: "2023-12-20T03:47:59.009Z",
      },
      {
        ...
        updatedAt: "2023-12-18T13:58:21.533Z",
      },
      {
        ...
        updatedAt: "2023-12-14T11:54:54.426Z",
      },
      {
        ...
        updatedAt: "2023-12-11T01:21:38.190Z",
      },
      {
        ...
        updatedAt: "2023-12-20T03:47:56.764Z",
      },
    ],
    pagination: {
      page: 1,
...
const products =
  productdata.data.products.map(({ _id, price, images }) => {
    return `
    <div key=${_id}>
      ${images
        .map(
        ...
        .join("")}
      <p> ID: ${_id} và có giá là ${price ?? "N/A"} </p> 
    </div>`;
  }) ?? [];
